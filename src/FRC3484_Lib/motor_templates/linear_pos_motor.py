...
class LinearPositionMotor(Subsystem):
    '''
    ...
    def __init__(
        ...
        self._previous_velocity: feet_per_second = 0
    ...
    def at_target_angle(self) -> bool:
        ...
        '''
        return abs(self._target_state.position - self.get_position()) < self._position_tolerance
